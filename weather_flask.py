...
long_lat = {'longitute': [53.3498, 51.5072, 48.8575, 35.6764, 40.7128, 28.6139, 25.2048, 39.9042],
            'latitude': [6.2603, 0.1276, 2.3514, 139.6500, 74.0060, 77.2088, 55.2708, 116.4074]}
...
def submit():
    ...
    historical_temp = weather_check.get_historical_temperatures(long, lat, date)
